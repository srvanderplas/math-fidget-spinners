...
stext = [ "B", "l", "u", "e", "s", "t", "e", "m", " ", "M", "o", "n", "t", "e", "s", "s", "o", "r", "i"];
//stext = [];
                    ...
                    union(){
                        difference(){
                            ...
                            union(){
                                ...
                                translate([0,0,width-text_height])
                                linear_extrude(height = text_height)
                                text(text[0], size = text_size*textscale[0], font=myfont,halign="center", valign="center");
                                
                                // bottom side -- division
                                rotate([180,0,180])
                                translate([0, 0, -text_height])
                                linear_extrude(height = text_height)
                                text(text[1], size = text_size*textscale[1], font=myfont, halign="center", valign="center");
                            }
